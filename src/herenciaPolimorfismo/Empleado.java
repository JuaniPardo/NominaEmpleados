...
import herenciaPolimorfismo.complementosSalariales.ComplementoAntiguedad;
import herenciaPolimorfismo.complementosSalariales.ComplementoSalarial;
...
public abstract class Empleado {
    ...
    public static double calcularHorasPromedio(ArrayList<Empleado> empleados) {
        double horasPromedio = 0;
        for (Empleado empleado : empleados) {
            horasPromedio += empleado.horasTrabajadas;
        }
