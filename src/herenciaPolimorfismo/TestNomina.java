...
import herenciaPolimorfismo.complementosSalariales.ComplementoInsalubridad;
import herenciaPolimorfismo.complementosSalariales.ComplementoNocturnidad;
import herenciaPolimorfismo.complementosSalariales.ComplementoProductividad;
...
public class TestNomina {
    public static void main(String[] args) {
        ...
        System.out.printf("%s\n%s: $%,.2f\n\n", empleadoContratado, "Ingresos", empleadoContratado.ingresos());
